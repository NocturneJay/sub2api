        ...
        >
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                v-if="row.platform !== 'composite' && !authStore.isSimpleMode"
...
// 上游那版是「按平台选」的下拉（compositeRoutePlatformOptions），与 aicat 的
// 「必须委托到具体目标分组」相冲突，且模板里已改用下面这个分组选择器，
// 因此不保留——留着会是一个无人引用的 computed。
