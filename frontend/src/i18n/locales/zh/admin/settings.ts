    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          firstOrder: {
            title: '首单双向奖励（首充礼）',
            description: '被邀请人注册时自动持有一张首充券：首笔站内支付订单达到阈值时双方各得一份奖励；首单不满阈值则该券当场作废、后续充值不补。',
            enabled: '启用首单双向奖励',
            ...
            inviterBonus: '邀请人奖励（美元）',
            inviterBonusDesc: '达标时计入邀请人的返利额度，与常规比例返利叠加发放，且不占用「单人返利上限」。0 = 不发。修改会立即影响所有尚未下首单的用户。',
            validDays: '首充券有效期（天）',
