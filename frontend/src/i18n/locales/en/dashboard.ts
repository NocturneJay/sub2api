export default {
  ...
  modelPlaza: {
    title: 'Model Plaza',
    description: 'Browse all available models and pricing, converted by group rate',
    ...
    inOutHint: 'Prices are input / output, in $/1M tokens',
    columns: {
      model: 'Model',
      platform: 'Provider',
      billing: 'Billing',
