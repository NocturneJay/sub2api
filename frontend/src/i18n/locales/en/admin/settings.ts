      ...
      features: {
        ...
        affiliate: {
          ...
          firstOrder: {
            ...
            description: 'Every invitee holds a first-recharge voucher from signup: when their first delivered on-site order reaches the threshold both sides get a bonus; if it falls short the voucher is voided on the spot and never reissued.',
            ...
            inviterBonus: 'Inviter Bonus (USD)',
            inviterBonusDesc: 'Added to the inviter rebate quota on top of the regular percentage rebate, and excluded from the per-invitee rebate cap. 0 = none. Changes take effect immediately for every user who has not placed a first order yet.',
