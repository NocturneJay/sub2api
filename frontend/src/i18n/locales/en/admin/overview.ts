export default {
    ...
    groups: {
      ...
      compositeRoutes: {
        ...
        targetGroupPlaceholder: 'Select a sub-group to delegate to',
        targetGroupRequired: 'Please select a target group',
        targetGroupHint: 'Requests are forwarded to and priced by this sub-group; quota/billing still stays on this composite group',
