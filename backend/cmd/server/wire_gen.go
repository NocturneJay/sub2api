...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subscriptionHandler := handler.NewSubscriptionHandler(subscriptionService, paymentConfigService)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, gatewayService, geminiMessagesCompatService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, configConfig, coordinator)
	...
	plazaPublicHandler := handler.NewPlazaPublicHandler(channelService, apiKeyService, settingService)
