...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		LinuxDoConnectAPICnClientID:                            settings.LinuxDoConnectAPICnClientID,
		LinuxDoConnectAPICnClientSecretConfigured:              settings.LinuxDoConnectAPICnClientSecretConfigured,
		LinuxDoConnectAPICnRedirectURL:                         settings.LinuxDoConnectAPICnRedirectURL,
		...
		GoogleOAuthAPICnRedirectURL:                            settings.GoogleOAuthAPICnRedirectURL,
		...
		ModelPlazaPublicIncludeSubscriptionGroups: settings.ModelPlazaPublicIncludeSubscriptionGroups,
