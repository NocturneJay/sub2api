...
func registerRoutes(
	...
	// aicat 自研广场的公开端点(/api/v1/plaza/models)，自带 IP 归因限流。
	routes.RegisterPlazaPublicRoutes(v1, h, optionalJWTAuth, settingService, redisClient)
	// 上游自带广场(/api/v1/model-plaza)：后端保留、前端不路由，见 handler.Handlers 注释。
